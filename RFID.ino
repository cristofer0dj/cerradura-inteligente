...
byte Usuario1[4] = {0x59, 0x63, 0x8F, 0xC2}; //Creamos otro array con los valores de nuestros tags 
byte Usuario2[4] = {0xA3, 0xEB, 0xB4, 0x03};// USUARIO 2 
...
Serial.println("Bienvenida Katy "); 
